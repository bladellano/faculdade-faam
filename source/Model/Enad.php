...
class Enad extends Model
{
    const ERROR = 'EnadError';
    const TABLE = 'enads';
    ...
    public static function firstEnad()
    {
        $sql = new Sql();
    ...
    {
        $_SESSION[Enad::ERROR] = $msg;
    }

    public static function getError()
    {
        $msg = (isset($_SESSION[Enad::ERROR]) && $_SESSION[Enad::ERROR]) ? $_SESSION[Enad::ERROR] : '';
        Enad::clearError();
        return $msg;
    }
